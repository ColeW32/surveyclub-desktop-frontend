        ...
        <div className="w-full max-w-md px-8 py-12 bg-white/5 backdrop-blur-2xl border border-white/10 rounded-[2.5rem] shadow-2xl shadow-black/50">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              disabled={isSigningIn}
              className="group w-full flex items-center justify-center space-x-4 px-6 py-4 bg-black text-white border border-gray-800 rounded-2xl font-bold text-base hover:bg-gray-900 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 disabled:opacity-70 disabled:cursor-not-allowed shadow-xl shadow-black/20"
            >
              {isSigningIn ? (
                <div className="w-6 h-6 border-2 border-gray-600 border-t-white rounded-full animate-spin"></div>
              ) : (
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.74 1.18 0 2.29-1.23 3.57-1.23.6 0 2.72.16 3.76 1.64-3.42 2.03-2.3 6.63 1.32 8.13-.63 1.7-1.67 3.36-3.73 3.69zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z" />
                </svg>
              )}
